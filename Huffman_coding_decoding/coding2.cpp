...
void printTree_2(Node_2* temp, vector <int> whichWayIveGone)
{
	...
	{
		int firstchar = stoi(temp->symbol);
		cout << "Im terminal leaf with symbol: " << firstchar << " and frequancy: " << temp->frequency << " and i've been going through the: ";
